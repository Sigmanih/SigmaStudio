...
def register_get_handlers(handler_class):
    ...
    core_routes = {
        ...
        '/api/list_ruoli': 'handle_list_ruoli',
        '/api/manifesti': 'handle_list_manifesti',
        '/api/ruoli': 'handle_list_ruoli',
        ...
        '/api/ruoli/hub': 'handle_ruoli_hub',
...
def register_post_handlers(handler_class):
    ...
    core_routes = {
        ...
        '/api/ruoli/update_image': 'handle_update_ruolo_image',
        ...
        '/api/ruoli/install_from_hub': 'handle_ruoli_install_from_hub',
        '/api/manifesti/uninstall': 'handle_manifesti_uninstall',
        '/api/ruoli/uninstall': 'handle_ruoli_uninstall',
