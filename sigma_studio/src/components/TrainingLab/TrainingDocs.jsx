...
const METHOD_CARDS = [
  ...
  },
  {
    ...
    icon: '🧬',
    color: '#3fb950',
    desc: 'Functional Weight Engine: i pesi non vengono salvati ma GENERATI da un decoder AILO da 152M congelato, guidato da un codebook VQ e dalle coordinate del blocco. Non è fine-tuning: è compressione. Il payload per-modello scende a ~0.5 MB perché il decoder si paga una volta sola. Motore con forward e backward scritti a mano (nessun autograd), percorsi CUDA ottimizzati.',
    quando: 'Vuoi comprimere un modello mantenendone la perplexity, o fare ricerca su generatori di pesi',
    vram: '6-16 GB',
    difficolta: 'Ricerca',
  ...
  },
  {
    ...
    icon: '🛠️',
    color: '#ff7043',
    desc: 'Template Python generico da personalizzare, con preambolo CUDA già pronto (DEVICE, DTYPE, TUNE calcolati sull\'hardware reale). Per utenti esperti che vogliono scrivere il proprio loop di training.',
